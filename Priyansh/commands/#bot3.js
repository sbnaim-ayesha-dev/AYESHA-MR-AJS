...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Ayesha") || (event.body.toLowerCase() == "@A Y E S H A    Q U E E N    A J S ")) {
     return api.sendMessage("💐𝐘𝐞 𝐓𝐨 𝐇𝐚𝐬𝐢𝐧𝐚 𝐇𝐚𝐢 𝐌𝐞𝐫𝐢 𝐉𝐚𝐧 𝐇𝐚𝐢 𝐌𝐞𝐫𝐞 𝐃𝐢𝐥 𝐤𝐢 𝐃𝐡𝐚𝐝𝐤𝐚𝐧 𝐇𝐚𝐢☺️", threadID);
   };
   mess = "{name}"

  if (event.body.indexOf("Ajs69") >= 0 || (event.body.indexOf("Mot69") >= 0)) {
    var msg = {
      body: `❤️🌿🍒${name}🌿🥀💙, \n\n
          ${rand} 🤣🍁❤
